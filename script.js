...
fetch("pokemon.json", {
    ...
    .then(response => {
        ...
        if (!response.ok) {
            ...
            throw new Error(
                `pokemon.json introuvable (${response.status})`
            );
    ...
    .then(text => {
        ...
        try {
            ...
            throw new Error(
                "pokemon.json contient une erreur de syntaxe JSON."
            );
        ...
        if (!Array.isArray(data)) {
            ...
            throw new Error(
                "pokemon.json doit contenir un tableau de Pokémon."
            );
    ...
    .catch(error => {
        ...
        console.error(
            "Erreur de chargement du Pokédex :",
            error
        );
